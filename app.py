...
with st.sidebar:
    ...
    st.markdown("""
        <div style="padding: 0 28px;">
            <p style="font-size:12px; color:rgba(200,185,140,0.35); line-height:1.7; font-weight:300;">
                Powered by logistic regression trained on historical IPL delivery data.
            </p>
        </div>
    """, unsafe_allow_html=True)

    st.markdown("""
        <div style="position:absolute; bottom:28px; left:0; right:0; padding:0 28px;">
            <div style="font-size:9px; letter-spacing:1.5px; text-transform:uppercase; color:rgba(200,185,140,0.2);">
